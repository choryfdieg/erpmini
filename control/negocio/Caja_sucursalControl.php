...
class Caja_sucursalControl {

    function Caja_sucursalControl() {
    ...
    public function getCaja_sucursals($request) {
        ...
        $entities = $caja_sucursalFacade->setParams(array('filters' => array(" and sucursal_id = {$sucursal_id}"), 'likeArray' => true))->findEntities();
        $entitiesData = array();
