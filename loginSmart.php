                            ...
                            <form role="form" action="index.php" method="POST">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="E-mail" name="login" type="text" autofocus required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="submit" class="btn btn-lg btn-success btn-block" value="Login" name="ingresar"/>
                                    <?php echo $mensaje?>
                                </fieldset>
                            </form>
                        </div>
